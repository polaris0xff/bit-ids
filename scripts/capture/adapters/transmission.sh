...
#
# ⚠ Only the package route reaches this: the release route fetches a source
# archive and refuses, because this adapter cannot build it, and a route that
# installs nothing must not report a packaging either.
