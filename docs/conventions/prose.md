...
[`markers.go`](../../tools/check/markers.go) refuses a file
...
[`markers.go`](../../tools/check/markers.go) can hold, and it
holds it.
...
sentence.** [`onehome.go`](../../tools/check/onehome.go)
...
to [`markers.go`](../../tools/check/markers.go), which reads
