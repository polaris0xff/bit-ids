...
| a complaint about a person or a project | it violates [`../conventions/prose.md`](../conventions/prose.md); record only the technical constraint |
...
everywhere. `tools/check/markers.go` reads this directory like any
other.
